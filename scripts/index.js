...
function createNewGame() {
	...
	for (var i = 0; i < number_of_items; i++) {
		...
		var randomNumber = Math.floor(Math.random() * (sessionData.length-1));
		...
		switch (option) {
			...
			case 'online_pic':
				...
				break;
			case 'local_pic':
				trs[i % items_per_row] += "<div class=\"word\" id=\'" + i + "\' onclick=\"clicked(\'" + i + "\')\"><div><a href=\"#\">" + word + "<span class=\"ada\"></span></a></div></div>";
				break;
			default:
